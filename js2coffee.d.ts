 ...
 */
declare function js2coffee(source: string, options?: js2coffee.IJS2CoffeeOptions): string;
...
declare namespace js2coffee {
	 ...
	 */
	function build(source: string, options?: IJS2CoffeeOptions): IJS2CoffeeBuild;
	 ...
	 * @param {string} [options.source] The source code itself - always overwritten by
	 * `source`.
	 * @returns {IJS2CoffeeTransform} Abstract syntax tree for post-transform CoffeeScript.
	 */
	function transform(ast: IJS2CoffeeAST, options?: IJS2CoffeeOptions): IJS2CoffeeTransform;
	 ...
	 */
	function generate(ast: IJS2CoffeeTransform, options?: IJS2CoffeeOptions): CodeWithSourceMap;
	 ...
	 * @member end.column Error end line number.
	 * @member end.line Error end column number.
	 * @member start Error start position.
	 * @member end.column Error start column number.
	 * @member start.line Error start line number.
	 */
	interface IJS2CoffeeError extends Error {
		description: string;
		end: {
			line: number;
			column: number;
	 ...
	 */
	interface IJS2CoffeeEsprimaStyleError {
		column: number;
		description: string;
		lineNumber: number;
	}
	 ...
	 */
	interface IJS2CoffeeSyntaxProblem extends IJS2CoffeeError {
		filename: string;
		js2coffee: true;
